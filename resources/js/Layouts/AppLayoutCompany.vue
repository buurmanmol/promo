                            ...
                            <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100" leave-active-class="transition ease-in duration-75" leave-from-class="transform opacity-100 scale-100" leave-to-class="transform opacity-0 scale-95">
                                <MenuItems class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                                    <MenuItem v-slot="{ active }">
                                        <a href="/user/profile" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">Mijn Account</a>
                                    </MenuItem>
                                    <MenuItem v-slot="{ active }">
                                        <Link  :class="[active ? 'bg-gray-100' : '', 'block px-4 w-full text-left py-2 text-sm text-gray-700']" href="/logout" method="post" as="button" type="button">Uitloggen</Link>
                                    </MenuItem>
                                </MenuItems>
                            </transition>
                        </Menu>
...
const navigation = [
    ...
    { name: 'Facturen', href: '/company/facturen', icon: DocumentTextIcon, current: 'facturen' },
    { name: 'Reparaties', href: '/company/repairs', icon: TicketIcon, current: 'reparaties' },
    { name: 'Apparaten', href: '/company/apparaten', icon: DeviceMobileIcon, current: 'apparaten'},
]
