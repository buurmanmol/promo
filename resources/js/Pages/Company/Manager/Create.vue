...
<template>
    <app-layout-company :company="company" :user="user" :page="page">
                ...
                <div class="pt-8">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Gebruik svp een permanent e-mailadres waarop u
                            e-mails kan ontvangen
                        </p>
                    </div>
                    <div
                        class="
...
export default {
    ...
    methods: {
        ...
        createUser() {
            axios.post("/api/users/create", this.user).then(
                (response) => {
                    window.location = "/company/managers";
                },
                (error) => {
                    this.errors.push("Error 500. Interne error");
                    console.log(error);
                }
            );
        },
