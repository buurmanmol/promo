            ...
            <div class="block pb-12">
                ...
                <div class="relative py-8 w-full">
                    ...
                    <fade-transition>
                        <div
                            v-if="selectedSlide === 2"
                            class="absolute left-4 top-10 bg-white"
                        >
                            <div class="grid grid-cols-2">
                                <div class="col-span-2 md:col-span-1">
                                    <Disclosure as="div" class="pt-6">
                                        ...
                                        <DisclosurePanel as="dd" class="pr-12">
                                            <p
                                                ...
                                                "
                                            >
                                                Hier kunt u het model van uw
                                                toestel zoeken. <br />
                                                Klik op het gewenste model en
                                                klik daarna op de "volgende"
                                                knop.
                                            </p>
                                        </DisclosurePanel>
                                    ...
                                    <Disclosure as="div" class="pt-6">
                                        ...
                                        >
                                            <p class="text-base text-gray-500">
                                                ...
                                                toevoegen. <br />
                                                Om een nieuw soort toestel toe
                                                te voegen klikt u hier:
                                            </p>
                                        </DisclosurePanel>
                                        <div class="my-4">
...
export default {
    ...
    methods: {
        postsDevices() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.post("/api/device/create", this.devices).then(
                        (response) => {
                            Swal.fire(
                                "Apparaat aangemaakt!",
                            ...
                            window.location = "/manager/apparaten";
                        },
                        (error) => {
                            console.log(error);
                        }
        ...
        getModels() {
            axios.get("/api/brands/" + this.brand.id + "/models").then(
                (response) => {
