                                    ...
                                    <Disclosure as="div" class="pt-6">
                                        ...
                                        <DisclosurePanel as="dd" class="pr-12">
                                            <p
                                                ...
                                                "
                                            >
                                                Hier kunt u het merk van uw
                                                toestel zoeken. <br />
                                                Klik op het gewenste merk en
                    ...
                    <fade-transition>
                        ...
                        >
                            <div class="grid grid-cols-2">
                                ...
                                <div
                                    class="relative lg:mt-6 col-span-2"
                                    aria-hidden="true"
                                >
                                    <div class="grid grid-cols-2">
                                    ...
                                    <div v-if="repairDate" class="max-w-xs">
                                        <label
                                            ...
                                            class="
                                                ...
                                                text-gray-700
                                            "
                                            >Aantal reparaties van ditzelfde
                                            toestel</label
                                        >
                                        <div
                                            class="
...
export default {
    ...
    methods: {
        ...
        postRepairs() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios
                        .post(
                            "/api/repairs/" + this.currentUser.id + "/create",
                            this.repairs
                        )
                        .then(
                            (response) => {
        ...
        getDevices() {
            axios
                .get("/api/user/" + this.currentUser.id + "/devices/unique")
                .then(
                    (response) => {
