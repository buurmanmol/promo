                    ...
                    <div class="lg:pr-8">
                        <div class="max-w-md mx-auto sm:max-w-lg lg:mx-0">
                            ...
                            <p class="mt-4 text-lg text-gray-500 sm:mt-3">
                                Bent u benieuwd wat PromoFix voor uw bedrijf kan betekenen?
                            </p>
                            <form action="#" method="POST" class="mt-9 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="company" class="block text-sm font-medium text-gray-700">Bedrijf</label>
                                    <div class="mt-1">
                                ...
                                <div class="sm:col-span-2">
                                    <div class="flex justify-between">
                                        <label for="how-can-we-help" class="block text-sm font-medium text-gray-700">Wat voor apparaten heeft u binnen uw bedrijf?</label>
                                        <span id="how-can-we-help-description" class="text-sm text-gray-500">Max. 500 letters</span>
                                    </div>
                                    <div class="mt-1">
                                    ...
                                    <div class="mt-4 grid grid-cols-1 gap-y-4">
                                        <div class="flex items-center">
                                            ...
                                            <label for="budget-under-25k" class="ml-3">
                                                <span class="block text-sm text-gray-700">1-15</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="budget-25k-50k" class="ml-3">
                                                <span class="block text-sm text-gray-700">15-30</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="budget-50k-100k" class="ml-3">
                                                <span class="block text-sm text-gray-700">30-50</span>
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="budget-over-100k" class="ml-3">
                                                <span class="block text-sm text-gray-700">50+</span>
                                            </label>
                                        </div>
                                    </div>
                                </fieldset>
                                <div class="sm:col-span-2">
                                    <label for="how-did-you-hear-about-us" class="block text-sm font-medium text-gray-700">Hoe heeft u van ons gehoord?</label>
                                    <div class="mt-1">
