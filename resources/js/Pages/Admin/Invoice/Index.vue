                    ...
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        ...
                        <table class="min-w-full rounded-md divide-y divide-gray-200">
                            ...
                            <tr v-for="invoice in invoices" :key="invoice.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-500">lel</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                  <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                    Active
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a :href="'/admin/factuur/' + invoice.id + '/update'" class="text-azure-radiance-600 hover:text-azure-radiance-900">Edit</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
