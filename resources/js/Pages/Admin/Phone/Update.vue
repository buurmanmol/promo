                ...
                <div class="pt-8">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Voeg een nieuwe toestel toe dmv het invullen van de velden.
                        </p>
                    </div>
...
export default {
    ...
    methods: {
        checkForm:function(e) {
            this.errors = [];
            if(!this.phone.brand) this.errors.push("Merk vereist.");
            if(!this.phone.model) this.errors.push("Model vereist.");
