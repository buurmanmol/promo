                    ...
                    >
                        ...
                        >
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <template
                                    v-if="users"
                                    v-for="(user, key) in newRepairs.data ||
                                    users.data"
                                    :key="user.id"
                                >
                                    <tr>
                        ...
                        <pagination
                            v-if="users"
                            :links="sortedUsers.links || users.links"
...
export default {
    ...
    methods: {
        ...
        postDate(repair) {
            ...
            date.add(1, "d");
            axios
                .post("/api/repair/" + repair.id + "/plan", {
                    repair_date: date,
                })
                .then(
                    (response) => {
        ...
        searchRepairs() {
            axios.post("/api/repairs/search", { search: this.search }).then(
                (response) => {
        ...
        postRepair(repair, brand, model) {
            axios.post("/api/repair/" + repair.id + "/update", repair).then(
                (response) => {
        ...
        postIsRepaired(repair, brand, model) {
            axios
                .post("/api/repair/" + repair.id + "/is-repaired", repair)
                .then(
                    (response) => {
                        this.models = response.data.data;
                    },
        ...
        repairItem(repair, brand, model) {
            axios.post("/api/user/" + repair.id + "/repair-all").then(
                (response) => {
                    this.models = response.data.data;
                },
                (error) => {
        ...
        getModels(brand) {
            ...
            axios.post("/api/brand/models", newBrand).then(
                (response) => {
                    this.models = response.data.data;
                },
                (error) => {
